      ...
      <div class="row">
       ...
       <input type="button" onclick="location.href='{{route('verify.fir2')}}'" class="btn" style= "background-color: #3C8DBC; width: 150px;color: white;margin-left: 170px;" value="FIR info">
        ...
        @endif
            ...
            <form action="add-witness-info" method="POST">
              <div class="box-body">
              ...
              <div class="form-group @if ($errors->has('phno')) has-error @endif" style="width: 450px;float: right;">
                <label> Phone No </label>
                <input type="PhoneNo" class="form-control" placeholder="Phone No" name="phno">
                @if ($errors->has('phno')) <p class="help-block">{{ $errors->first('phno') }}</p> @endif
              </div>
              ...
              <!-- select 3 -->
                 ...
                 <div class="form-group @if ($errors->has('town')) has-error @endif" style="width: 450px;float: right;">
                  <label> Town </label>
                  <select class="form-control" placeholder="Town" name="town" id="town">
              ...
              <!-- select 5 -->
              <div class="form-group @if ($errors->has('hno')) has-error @endif" style="width: 450px;float: right;">
               ...
               <div class="form-group @if ($errors->has('street')) has-error @endif">
                  <label style="width: 450px;"> Street </label>
