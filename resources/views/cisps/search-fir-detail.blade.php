        ...
        <div class="col-md-11">
           <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Search FIR</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="fir-search" method="POST">
              <div class="box-body">
              ...
              <div class="form-group" style="width: 400px;float: left;">
               ...
               <option value=" ">-Select Province-</option>
                ...
                <div class="form-group" style="width: 450px;float: right;">
                  <label> City </label>
                  <select class="form-control" placeholder="City" id="city" name="city">
                ...
                <div class="form-group" style="width: 400px;float: left;">
                  ...
                  <select class="form-control" placeholder="District" id="district" name="district">
 ...
 //         console.log(data);
     ...
     $(document).ready(function(){  
        ...
        changeDistrict();
                  ...
                  <div class="form-group" style="width: 450px;float: right;">
                  <label> FIR ID </label>
                  <input type="text" class="form-control" name="firid" placeholder="FIR ID"> 
                  </div>
              ...
              <div class="table-responsive">
                <table class="table no-margin row text-center">
                  ...
                  <tbody>
                  @foreach ($firs as $index=>$i)  
                  <tr>
                    <td>{{$index+1}}</td>
                    <td><a href="view-fir-details/{{$i->fir_id}}">{{$i->fir_id}}</a></td>
                    <td>{{$i->crime_type}}</td>
                    <td>
                    @if($i->fir_type==1)
                    ...
                    <span class="label label-danger">Pending</span>
                    @endif
                    @if($i->fir_type==0 && $i->fir_status==1)
                    ...
                    <td>
                      <div class="sparkbar" data-color="#00a65a" data-height="20">{{ Carbon\Carbon::parse($i->fir_submit_date)->format('d-m-Y') }}</div>
                    </td>
                  </tr>
                  @endforeach
