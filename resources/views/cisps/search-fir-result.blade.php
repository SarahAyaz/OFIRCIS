      ...
      <div class="row">
        ...
        <h3>FIR DETAILS</h3>
         <table border="2" align="center">
              ...
              <td><textarea readonly rows="4" cols="30" style="border: none"></textarea></td>
              </tr>
              <tr>
              ...
              <a href="print-ver-fir" target="_blank" style="width: 3cm; float: center" class="btn btn-primary"><i class="fa fa-print"></i> Print</a>
