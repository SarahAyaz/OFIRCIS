...
<html>
  <head>
    ...
    <link rel="stylesheet" href="bootstrap/help-style.css">
...
<section id="introduction">
  ...
  <p class="lead">
    <b>Online FIR & Criminal Information System</b> 
    ...
    <div class="col-sm-6">
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <a href="Audio/F002.mp3" download><i class="fa fa-download"></i> Download</a>
        </div><!-- /.box-body -->
      </div><!-- /.box -->
    </div><!-- /.col -->
    <div class="col-sm-6">
  ...
  <p class="lead">
    ...
    Attribution is not required (though very much appreciated).
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; -2017 <a href="#">Flexura FYP 2017</a>.</strong> All rights reserved.
      </footer>
    ...
    <script src="bootstraps/help-docs.js"></script>
  </body>
</html>
