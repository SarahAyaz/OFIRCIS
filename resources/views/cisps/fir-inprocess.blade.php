        ...
        <div class="col-xs-12">
           <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">FIR's in My Police Station</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
            ...
            <input type="button" onclick="location.href='fir-pending';" class="btn" style= "background-color: #3C8DBC;width: 150px;color: white"  value="Pending">
       <input type="button" onclick="location.href='fir-inprocess';" class="btn" style= "background-color: #3C8DBC;width: 150px;color: white"   value="In-Process">
         <input type="button" onclick="location.href='fir-closed';" class="btn" style= "background-color: #3C8DBC;width: 150px;color: white"   value="Closed">
            
             
                 <div class="box">
            <div class="box-header">
              <h3 class="box-title">In-Process FIR's</h3>
