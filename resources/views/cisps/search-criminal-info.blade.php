      ...
      <div class="row">
           ...
           <div class="box box-primary">
            ...
            <form role="form" action="criminal-search" method="POST">
              <div class="box-body">
                ...
                <input type="text" name="cnic" style="width: 350px;height:30px;" placeholder="00000-0000000-0">
                  ...
                  <div class="row text-center"> 
                   ...
                   <form action="add-criminal-fir" method="POST">
                   @foreach ($info as $i) @endforeach 
        <h3>CRIMINAL DETAILS</h3>
         <table border="2" align="center">
              ...
              <tr>
              <td><b><center>Father Name:</center></b></td>
              <td>{{$i->cr_father_name}}</td>
              </tr>
              <tr>
              <td><b><center>Mother Name:</center></b></td>
              <td>{{$i->cr_mother_name}}</td>
              </tr>
              <tr>
              ...
              <tr>
              <td><b><center>Nationality:</center></b></td>
              <td>{{$i->cr_nationality}}</td>
              </tr>
              <tr>
              ...
              <tr>
              <td><b><center>Cast:</center></b></td>
              <td>{{$i->cr_cast}}</td>
              </tr>
              <tr>
              <td><b><center>District:</center></b></td>
              <td>{{$i->district}}</td>
              </tr>
              <tr>
              ...
              <tr>
              <td><b><center>Province:</center></b></td>
              <td>{{$i->province}}</td>
              </tr>
              <tr>
              <td><b><center>Address:</center></b></td>
              <td><textarea readonly rows="2" cols="50" style="border: none;text-align: center;"> {{$i->cr_house_no}} , {{$i->cr_street}} , {{$i->cr_area}}, {{$i->cr_town}}</textarea></td>
              </tr>
              <tr>
              ...
              <tr>
              <td><b><center>D.O.B:</center></b></td>
              <td>{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $i->cr_dob)->format('Y-m-d') }}</td>
              </tr>
              <tr>
              <td><b><center>Language:</center></b></td>
              <td>{{$i->cr_lang}}</td>
              </tr>
              <tr>
              <td><b><center>Identity Mark:</center></b></td>
              <td>{{$i->cr_iden_mark}}</td>
              </tr>
              <tr>
              <td><b><center>Complexion:</center></b></td>
              <td>{{$i->cr_complexion}}</td>
              </tr>
              <tr><td><b><center>Height:</center></b></td>
              <td>{{$i->cr_height}}</td>
              </tr>
              <tr>
              <td><b><center>Eye Color:</center></b></td>
              <td>{{$i->cr_eye_color}}</td>
              </tr>
              <tr>
...
<div class="box-body">
       <div class="form-group" style="width: 450px;">
                 <label class="head3"> Criminal Pictures </label>
               </div></br>

                 <label   class="head3" style="width: 340px;float: left;"> left </label>
                <label   class="head3" style="width: 340px;float: left;"> front </label>
                <label   class="head3" style="width: 340x;float: left;"> right </label>
                <div class="form-group" style="width: 325px;float: left;"> 
                 <div id='clock' ><img id="myImg" src="{{$i->cr_picture}}1.jpg" style="height: 100%; width: 100%;">
                  </div></div>
                  <!-- The Modal -->

                  <div class="form-group"style="width: 325px;float: left;">
                  
                  <div id='clock1'><img id="myImg1" src="{{$i->cr_picture}}2.jpg" style="height: 100%; width: 100%;">
                  </div></div>
                  <div class="form-group"style="width: 325px;float: left;">
                  
                  <div id='clock2' ><img id="myImg2" src="{{$i->cr_picture}}3.jpg" style="height: 100%; width: 100%;">
                  </div></div>
  ...
  <div id="caption"></div>
                 ...
                 <div class="form-group" style="width: 450px;">
                 <label class="head3"> Criminal Thumb prints </label>
               </div>
                 
                 <div id='clock3' style="width: 190px;float: left;" >
                  </div>
 
                  <div id='clock4'style="width: 190px;float: left;">
                  </div>

                  <div id='clock5' style="width: 190px;float: left;">
                  </div>
                   
                 <div id='clock6'style="width: 190px;float: left;" >
                  </div>
                  
                  
                  <div id='clock7'style="width: 190px;float: left;">
                  </div>
                  
                  
                  <div id='clock8'style="width: 190px;float: left;" >
                  </div>
                  
                 <div id='clock9' style="width: 190px;float: left;">
                  </div>
                  
                  
                  <div id='clock10' style="width: 190px;float: left;">
                  </div>
                  
                  
                  <div id='clock11' style="width: 190px;float: left;">
                  </div>
                   
                  
                  <div id='clock12' style="width: 190px;float: left;" >
                  </div>
...
<div class="box-footer text-center" >
                <input type="button" onclick="location.href='edit-criminal'"  class="btn btn-primary" style="width: 3cm;" value="Edit"/>
              </div>
 @if ($i->fir_id!= "")
 <div class="row text-center"> 
                   <div class="col-xs-12 table-responsive">
...
<!-- /.box-header -->
            <div class="box-body row text-center">
              <div class="table-responsive">
                <table class="table no-margin row text-center">
                  ...
                  <tr>
                    <td>{{$index+1}}</td>
                    <td><a href="fir-info">{{$i->fir_id}}</a></td>
                    <td>{{$i->crime_type}}</td>

                     @if ($i->fir_type == 1) <td><span class="label label-danger">Open </span></td>
                     @else 
                    <td><span class="label label-warning">Closed </span></td>
                     @endif
                    <td>
            ...
            <div class="box-footer clearfix">
              <div class="form-group" align="center">
                  <div class="input-group input-group-sm" style="width: 450px;" >
                  <br>
                    <label class="head3"> FIR ID:  </label>&nbsp
                    
                      <input type="textarea"  name="fid" style="width: 300px;height:30px;">
                      <input type="hidden" name="_token" value="{{ csrf_token() }}"> &nbsp
                      <br><br>
                      <input type="submit"   class="btn btn-primary" value="Add New FIR">
