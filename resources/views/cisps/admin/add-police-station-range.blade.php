        ...
        <div class="col-md-11">
           <div class="box box-primary">
            ...
            @endif
              ...
              <h3 class="box-title">Add Police Station Range</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form role="form" action="add-range" method="POST">
              <div class="box-body">
                
               <div class="form-group @if ($errors->has('psname')) has-error @endif" style="width: 450px; float: left;">
                  <label>Police Station Name</label>
                  <input readonly type="text" name="psname" class="form-control" placeholder="Police Station Name" value="{{$name}}">
                   @if ($errors->has('psname')) <p class="help-block">{{ $errors->first('psname') }}</p> @endif  
      
                </div>

                <div class="form-group @if ($errors->has('psdid')) has-error @endif" style="width: 450px; float: right;">
                  <label> District ID </label>
                <input type="text" name="psdid" readonly class="form-control" placeholder="District ID" value="{{$psdid}}">
                 @if ($errors->has('psdid')) <p class="help-block">{{ $errors->first('psdid') }}</p> @endif  
      
              </div> 

              <div class="form-group @if ($errors->has('psarea')) has-error @endif"  >
                  <label> Area</label>
                <input type="text" name="psarea"  class="form-control" placeholder="Area" >
                 @if ($errors->has('psarea')) <p class="help-block">{{ $errors->first('psarea') }}</p> @endif  
...
<!-- TABLE: LATEST ORDERS -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Recently Added Area</h3>
              ...
              <div class="table-responsive">
                <table class="table no-margin row text-center">
                  ...
                  <tr>
                    ...
                    <th>Police District ID</th>
                    <th> Area</th>
                  </tr>
                  </thead>
                  @foreach($rangeinfo as $i)
                  <tbody>
                  <tr>
                    <td>{{$i->ps_name}}</td>
                    <td>{{$i->d_id}}</td>
