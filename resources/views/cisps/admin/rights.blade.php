        ...
        <div class="col-md-11">
           <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Rights for Police Station</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form role="form" action="fir-edit-rights" method="POST">
              <div class="box-body">
         ...
         <label >PS USER NAME</label>
                <select class="form-control"  name="psuname"  >
                 <option value="0">-PS User Name-</option>
                 @foreach($info as $add )
                 <option value="{{$add->ps_username}}">{{$add->ps_username}}</option>
                 @endforeach
                 
                </select>
                @if ($errors->has('psuname')) <p class="help-block">{{ $errors->first('puname') }}</p> @endif
              
                </div>


   <div class="form-group @if ($errors->has('psright')) has-error @endif" style="width: 450px;float: right;">
            <label >PS Rights</label>
                <select class="form-control"  name="psright"  >
              
              
                <option value="0">-Edit Rights-</option>
               
                 <option value="Allowed">Allowed</option>
                 <option value="NotAllowed">Not Allowed</option>
                 
                </select>
                @if ($errors->has('psright')) <p class="help-block">{{ $errors->first('psright') }}</p> @endif
              
                </div>
                   
 <input type="hidden" name="_token" value="{{ csrf_token() }}">
 
<div style="width: 200px; margin-left: 440px; margin-top: 80px;"   >
                <input type="submit" onclick="location.href='#'" style="width: 150px;" class="btn btn-primary" value="Save"/>
   ...
   <!-- /.Criinal Rights    -->
             ...
             <form role="form" action="criminal-edit-rights" method="POST">
              <div class="box-body">

   

    <div class="form-group @if ($errors->has('pscuname')) has-error @endif" style="width: 450px;float: left;">
         <label >PS USER NAME</label>
                <select class="form-control"  name="pscuname"  >
                 <option value="0">-PS User Name-</option>
                 @foreach($info as $add )
                 <option value="{{$add->ps_username}}">{{$add->ps_username}}</option>
                 @endforeach
                ...
                @if ($errors->has('pscuname')) <p class="help-block">{{ $errors->first('pucname') }}</p> @endif
              
                </div>

   <div class="form-group @if ($errors->has('pscright')) has-error @endif" style="width: 450px;float: right;">
            <label >PS Rights</label>
                <select class="form-control"  name="pscright"  >
                ...
                @if ($errors->has('pscright')) <p class="help-block">{{ $errors->first('pscright') }}</p> @endif
...
<div style="width: 200px; margin-left: 440px; margin-top: 80px;"   >
                <input type="submit" onclick="location.href='#'"  class="btn btn-primary" style="width: 150px;" value="Save"/>
