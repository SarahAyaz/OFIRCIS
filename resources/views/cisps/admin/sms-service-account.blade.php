...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-11">
           <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">SMS Service Account</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            ...
            <form role="form" action="update-sms-service" method="POST">
              <div class="box-body">
    ...
    <input type="text" class="form-control" placeholder="User name" name="uname" style="width: 250px;">
     @if ($errors->has('uname')) <p class="help-block">{{ $errors->first('uname') }}</p> @endif  
              
  </div> </br>

    <label>Password</label>
    <div class="form-group  @if ($errors->has('pwd')) has-error @endif ">
             
    <input class="form-control" placeholder="Password" name="pwd"  style="width: 250px;">
     @if ($errors->has('pwd')) <p class="help-block">{{ $errors->first('pwd') }}</p> @endif  
  
  </div></br>
 <input type="hidden" name="_token" value="{{ csrf_token() }}">
<div >
                <input type="submit" onclick="location.href='#'"  class="btn btn-primary" style="width: 100px;" value="Update"/>
</div>
