					...
					<div class="user-account" style="width:600px;">
						...
						<!-- select 1-->
						 <div class="form-group @if ($errors->has('phoneno')) has-error @endif">
								<input type="PhoneNo" class="form-control" placeholder="Enter Your Register Mobile Number" name="phoneno">
							...
							<input type="button" onclick="location.href='ofirclientsite';"  class="btn" value="Cancel"/>
						</form>
