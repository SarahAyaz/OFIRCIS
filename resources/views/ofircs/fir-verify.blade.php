  ...
  <body style="heigth=auto";>
	...
	<section id="main" class="clearfix user-page">
        ...
        @endif
						...
						<!-- select 1-->
						    <div class="form-group @if ($errors->has('ver_code')) has-error @endif">
		                   <label>Enter code:</label>
								<input type="text" name="ver_code" cols="35" rows="6" class="form-control" wrap="soft">
								@if ($errors->has('ver_code')) <p class="help-block">{{ $errors->first('ver_code') }}</p> @endif
							</div>
						...
						@endif
							<input type="submit" class="btn" value="Contiue"/>
							<input type="button" onclick="location.href='fir-form';"  class="btn" value="Cancel"/>
						</form>
