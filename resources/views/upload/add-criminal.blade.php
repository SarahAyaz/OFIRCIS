        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Gulberg PS</span>
            </a>
           ...
           <div class="box box-primary">
            ...
            <form role="form">
              ...
              <div class="form-group" style="width: 450px;float: right;">
               ...
               <input type="button" value="Access Camera" onClick="setup(); $(this).hide().next().show();">
                ...
                <div class="form-group" style="width: 340px;float: left;"> 
                 <div id='clock' class="pic1" onclick="SaveSnap()">
                  </div></div>
              ...
              <div class="box-footer text-center" >
                <input type="button" onclick="location.href='search-criminal'"  class="btn btn-primary" value="Submit"/>
              </div>
            </form>
          </div>
...
function take_snapshot(){
  counter+=1;
    ...
    //function to upload snap on server
    function SaveSnap()
  {
    alert("aler");
